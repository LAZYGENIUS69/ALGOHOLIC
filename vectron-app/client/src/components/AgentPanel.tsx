            ...
            <div className="agent-panel">
                <div className="agent-panel-shell">
                    <div className="agent-panel-header">
                        ...
                        <div className="agent-panel-subtitle">Powered by ASI:One Agentverse</div>
                        <div className="agent-badge">⚡ ASI:ONE</div>
                    </div>
                    ...
                    <div className="agent-status-line">ASI:One agents running in parallel...</div>
                </div>
            </div>
        );
    }
            ...
            <div className="agent-panel">
                <div className="agent-panel-shell">
                    ...
                    <div className="agent-bottom-bar">
                        <span>Generated by ASI:One Multi-Agent System</span>
        ...
        <div className="agent-panel">
            <div className="agent-panel-shell agent-panel-empty">
                ...
                <p className="agent-panel-copy">
                    ...
                    — each powered by ASI:One&apos;s extended reasoning.
                </p>
